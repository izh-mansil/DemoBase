...
Процедура ОбработкаНавигационнойСсылкиОткрытиеНастроекЭП(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ИначеЕсли НавигационнаяСсылкаФорматированнойСтроки = "ПроверитьУстановкуПрограммКриптографии" Тогда
		...
		МодульЭлектроннаяПодписьСлужебныйКлиент.ПроверитьУстановкуПрограммКриптографии(ЭтотОбъект, ПараметрыПроверки,
...
Функция АдресСтатьиСервисаDSS()
	...
	Возврат "https://its.1c.ru/db/translate?db=bspdoc&path=src/5.66 электронная подпись сервиса dss.htm&anchor=issogl2_требования_к_электронной_подписи_криптопро_dss";
