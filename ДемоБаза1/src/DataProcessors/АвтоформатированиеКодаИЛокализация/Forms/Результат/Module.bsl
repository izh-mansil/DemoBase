...
Процедура ОтборПоПропущеннымОшибкам(Команда)
	...
	Если Элементы.ОтборПоПропущеннымОшибкам.Пометка = Ложь Тогда
		...
		СтруктураОтбор.Вставить("Изменен", Истина);
		СтруктураОтбор.Вставить("Пропущено", НСтр("ru = 'Пропущено мест: '"));
	...
	Иначе
		...
		Элементы.Результат.ОтборСтрок = Новый ФиксированнаяСтруктура("Изменен", Истина);
